...
/* preparing data */
UPDATE `invheader` SET note = 'Invoice with total ' || total;
...
CREATE INDEX IF NOT EXISTS `idx_suppliers_postal_code` ON `suppliers`(postal_code);
...
CREATE TABLE IF NOT EXISTS `orders` (
 ...
 CREATE INDEX IF NOT EXISTS `idx_orders_customerid` ON `orders`(customer_id);
 CREATE INDEX IF NOT EXISTS `idx_orders_oustomersorders` ON `orders`(customer_id);
 CREATE INDEX IF NOT EXISTS `idx_orders_employee_id` ON `orders`(employee_id);
 CREATE INDEX IF NOT EXISTS `idx_orders_omployeesorders` ON `orders`(employee_id);
 CREATE INDEX IF NOT EXISTS `idx_orders_orderdate` ON `orders`(order_date);
 CREATE INDEX IF NOT EXISTS `idx_orders_shippeddate` ON `orders`(shipped_date);
 CREATE INDEX IF NOT EXISTS `idx_orders_ohippersorders` ON `orders`(ship_via);
 CREATE INDEX IF NOT EXISTS `idx_orders_shippostalcode` ON `orders`(ship_postal_code);
...
CREATE TABLE IF NOT EXISTS `products` (
 ...
 CREATE INDEX IF NOT EXISTS `idx_products_categoriesproducts` ON `products`(category_id);
 CREATE INDEX IF NOT EXISTS `idx_products_categoryid` ON `products`(category_id);
 CREATE INDEX IF NOT EXISTS `idx_products_productname` ON `products`(product_name);
 CREATE INDEX IF NOT EXISTS `idx_products_supplierid` ON `products`(supplier_id);
 CREATE INDEX IF NOT EXISTS `idx_products_suppliersproducts` ON `products`(supplier_id);
...
CREATE TABLE IF NOT EXISTS `order_details` (
 ...
 CREATE INDEX IF NOT EXISTS `idx_order_details_orderid` ON `order_details`(order_id);
 CREATE INDEX IF NOT EXISTS `idx_order_details_ordersdrder_details` ON `order_details`(order_id);
 CREATE INDEX IF NOT EXISTS `idx_order_details_product_id` ON `order_details`(product_id);
 CREATE INDEX IF NOT EXISTS `idx_order_details_oroducdsorder_details` ON `order_details`(product_id);
