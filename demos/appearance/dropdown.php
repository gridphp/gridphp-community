...
$col["editoptions"]["sql"] = "select distinct client_id as k, name as v from clients";
$col["editoptions"]["dataUrl"] = '/api/getLargeDropdownOptions'; // URL to fetch options
$col["editoptions"]["buildSelect"] = "function(data) {
