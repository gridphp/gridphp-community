...
$col["template"] = '<a href=\'javascript:window.open("https://www.google.com/?q={name}","newwind","height=500,width=800"); void(0);\'>{name}</a>'; 

// link formatter
// $col["formatter"] = 'link'; 
// $col["formatoptions"]["href"] = '/abc/?q={name}'; 
// $col["formatoptions"]["attr"] = 'target="_blank"'; 

// raw link formatter
// $col["formatter"] = "function(cellval,options,rowdata){ return '<a target=\"_blank\" href=\"//'+cellval+'\">'+cellval+'</a>'; }";
// $col["unformat"] = "function(cellval,options,cell){ return $('a', cell).attr('href').replace('//',''); }";
...
// e.g. https://domain.com?id={gender} given that, there is a column with $col["name"] = "gender" exist
// $col["template"] = "<a href='https://google.com/?q={gender}'>{gender}</a>";
