...
// if we want to restrict drag drop for certain rows
// $grid["loadComplete"] = "function(ids){
//     var val;
//     for (i = 0; i < ids.rows.length; i++) {
//         // disable drag drop rows if value of 'id' named column is > 7
//         val = ids.rows[i].id;
//         if (parseInt(val) > 7) 
//             jQuery('tr[id='+val+']').find('span.ui-sorticon').css('cursor','inherit').removeClass('ui-icon-grip-dotted-vertical').removeClass('ui-sorticon');
//     }	
// }";
