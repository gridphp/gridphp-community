...
$links["patients"] = array("Patients","index.php?mod=patients",false);
$links["appointments"] = array("Appointments","index.php?mod=appointments",false);
$links["doctors"] = array("Doctors","index.php?mod=doctors",false);
$links["prescriptions"] = array("Prescriptions","index.php?mod=prescriptions",false);
$links["payments"] = array("Payments","index.php?mod=payments",false);
$links["users"] = array("Users","index.php?mod=users",true);
$links["settings"] = array("Settings","index.php?mod=settings",true);

$reports = array();
$reports["patient_details"] = array("Patient Details","index.php?rep=patient_details",false);
$reports["appointment_details"] = array("Appointment Details","index.php?rep=appointment_details",false);
$reports["prescription_details"] = array("Prescription Details","index.php?rep=prescription_details",false);
...
<head>
	...
	<style>:root{--bs-dark-rgb: 8, 145, 178;--tabcolor: #088aa9;--tabhover: #077b97;}</style>
</head>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-6 col-sm-9" style="display:flex;align-items:center;gap:10px">
							...
							<span class="d-none d-sm-inline" style="font-size:10px;color:transparent;margin-top: 9px;">v1.0.0 - 20/10/2025</span>
						</div>
