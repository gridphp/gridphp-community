...
// grid properties
$grid->table = "tb_prescriptions";
$grid->select_command = "SELECT tb_prescriptions.id, tb_prescriptions.`patient`, tb_prescriptions.`doctor`, tb_prescriptions.`prescription_date`, tb_prescriptions.`medication`, tb_prescriptions.`dosage` FROM tb_prescriptions LEFT JOIN tb_patients ON tb_patients.`id` = tb_prescriptions.`patient` LEFT JOIN tb_doctors ON tb_doctors.`id` = tb_prescriptions.`doctor` WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_prescriptions.`id`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_prescriptions.`updated_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_prescriptions.`created_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["editable"] = true;
$col["formatter"] = "badge";
$col["dbname"] = "tb_prescriptions.`patient`";
$col["frozen"] = true;
$col["edittype"] = "lookup";
$col["isnull"] = "";
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_prescriptions.`doctor`";
$col["formatter"] = "badge";
$col["edittype"] = "lookup";
$col["isnull"] = "";
...
$col = array();
$col["name"] = "prescription_date";
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_prescriptions.`prescription_date`";
$col["formatter"] = "date";
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_prescriptions.`medication`";
$cols[] = $col;
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_prescriptions.`dosage`";
$cols[] = $col;

$grid->set_columns($cols,true);

$grid_id = "list_prescriptions";

// template variables
$var = array();
$var["out"] = $grid->render($grid_id);
$var["grid_id"] = "list_prescriptions";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Prescriptions Management";
$var["form_details"] = "";
$var["tab_class"] = "";
