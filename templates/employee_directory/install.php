...
<head>
	<meta charset="utf-8">
	<title>Employee Directory Installer | Grid 4 PHP Framework</title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<!-- Form Name -->
				<legend>Employee Directory — Application Template Installation</legend>
