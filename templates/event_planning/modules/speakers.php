...
// grid properties
$grid->table = "tb_speakers";
$grid->select_command = "SELECT tb_speakers.id, tb_speakers.`event`, tb_speakers.`name`, tb_speakers.`bio`, tb_speakers.`email`, tb_speakers.`phone_number` FROM tb_speakers LEFT JOIN tb_events ON tb_events.`id` = tb_speakers.`event` WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_speakers.`updated_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_speakers.`created_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_speakers.`phone_number`";
$col["formatter"] = "phone";
$cols[] = $col;

$grid->set_columns($cols,true);

$grid_id = "list_speakers";

// template variables
$var = array();
$var["out"] = $grid->render($grid_id);
$var["grid_id"] = "list_speakers";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Speakers Management";
$var["form_details"] = "";
$var["tab_class"] = "";
