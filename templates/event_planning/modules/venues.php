...
// grid properties
$grid->table = "tb_venues";
$grid->select_command = "SELECT tb_venues.id, tb_venues.`venue_name`, tb_venues.`address`, tb_venues.`capacity`, tb_venues.`event` FROM tb_venues LEFT JOIN tb_events ON tb_events.`id` = tb_venues.`event` WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_venues.`updated_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_venues.`created_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["dbname"] = "tb_venues.`venue_name`";
$col["frozen"] = true;
$cols[] = $col;
...
$var["grid_id"] = "list_venues";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Venues Management";
$var["form_details"] = "";
$var["tab_class"] = "";
