...
// grid properties
$grid->table = "tb_event_tasks";
$grid->select_command = "SELECT tb_event_tasks.id, tb_event_tasks.`task_name`, tb_event_tasks.`due_date`, tb_event_tasks.`status`, tb_event_tasks.`event`, tb_event_tasks.`assigned_to` FROM tb_event_tasks LEFT JOIN tb_events ON tb_events.`id` = tb_event_tasks.`event` LEFT JOIN tb_users ON tb_users.`id` = tb_event_tasks.`assigned_to` WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_event_tasks.`updated_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_event_tasks.`created_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["dbname"] = "tb_event_tasks.`task_name`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_event_tasks.`due_date`";
$col["formatter"] = "date";
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_event_tasks.`status`";
$col["formatter"] = "badge";
$col["edittype"] = "select";
$col["editoptions"]["value"] = $grid->get_dropdown_values("SELECT distinct `status` as k, `status` as v from tb_event_tasks");;
$col["stype"] = "select";
$col["searchoptions"]["value"] = $grid->get_dropdown_values("SELECT distinct `status` as k, `status` as v from tb_event_tasks");;
$cols[] = $col;
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_event_tasks.`event`";
$col["formatter"] = "badge";
$col["edittype"] = "lookup";
$col["isnull"] = "";
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_event_tasks.`assigned_to`";
$col["formatter"] = "badge";
$col["edittype"] = "lookup";
$col["isnull"] = "";
$col["editoptions"]["table"] = 'tb_users';
$col["editoptions"]["id"] = 'id';
$col["editoptions"]["label"] = 'name';
$col["editoptions"]["onload"] = array (
  'sql' => 'select distinct id as k, name as v from tb_users',
);
$col["badgeoptions"]["editurl"] = 'index.php?mod=users&grid_id=list_users&col=id';
$cols[] = $col;

$grid->set_columns($cols,true);

$grid_id = "list_event_tasks";

// template variables
$var = array();
$var["out"] = $grid->render($grid_id);
$var["grid_id"] = "list_event_tasks";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Event Tasks Management";
$var["form_details"] = "";
$var["tab_class"] = "";
