...
// grid properties
$grid->table = "tb_attendees";
$grid->select_command = "SELECT tb_attendees.id, tb_attendees.`name`, tb_attendees.`email`, tb_attendees.`phone_number`, tb_attendees.`event` FROM tb_attendees LEFT JOIN tb_events ON tb_events.`id` = tb_attendees.`event` WHERE 1=1 ";
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_attendees.`updated_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["hidden"] = true;
$col["dbname"] = "tb_attendees.`created_at`";
$col["frozen"] = true;
$cols[] = $col;
...
$col["width"] = 150;
$col["editable"] = true;
$col["dbname"] = "tb_attendees.`phone_number`";
$col["formatter"] = "phone";
$cols[] = $col;
...
$grid_id = "list_attendees";

// template variables
$var = array();
$var["out"] = $grid->render($grid_id);
$var["grid_id"] = "list_attendees";
$var["grid_theme"] = "base";
$var["locale"] = "en";
$var["form_title"] = "Attendees Management";
$var["form_details"] = "";
$var["tab_class"] = "";
