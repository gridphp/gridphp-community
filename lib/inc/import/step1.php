		...
		<div class="row" style="padding:15px">
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
				  <label class="col-md-2 control-label" for="csv_file">CSV File</label>
				  <div class="col-md-8">
				...
				<!-- Textarea -->
				<div class="form-group">
				  <label class="col-md-2 control-label" for="csv_str">CSV Content</label>
				  <div class="col-md-8">                     
				...
				<!-- Check -->
				<div class="form-group">
					<label class="col-md-2 control-label">Delimiter</label>
				  	<div class="col-md-8">                     
				...
				<!-- Button -->
				<div class="form-group">
				  <label class="col-md-2 control-label" for="import"></label>
				  <div class="col-md-8">
					  <button id="import" name="import" class="btn btn-default">Import</button>
					  <button id="close" name="close" class="btn btn-default" onclick="$('.ui-dialog-titlebar-close',window.parent.document).click(); return false;">Close</button>
				  </div>
				</div>
