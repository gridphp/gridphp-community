 ...
 * @version 3.1 build 20260713-1054
 * @license: see license.txt included in package
 */

define("AAAET",'.'); define("AAAEQ",'"'); define("AAAEO",'~'); define("AAAEM",'/^-/'); define("AAAEK",'lastListItemIndex'); define("AAAEI"," "); define("AAAEG",'lastItem'); define("AAAEE",'>'); define("AAAEC",'|'); define("AAAEA",'indent'); define("AAADX",'data'); define("AAADV","''"); define("AAADT","'"); define("AAADS",'off'); define("AAADR",'on'); define("AAADO",'no'); define("AAADN",'yes'); define("AAADL",'false'); define("AAADK",'true'); define("AAADI",'null'); define("AAADF",': '); define("AAADC",'- '); define("AAADB",' '); define("AAACZ",' '); define("AAACY",':'); define("AAACX",'-'); define("AAACW",' '); define("AAACT",''); define("AAACR","ffe97cb337457fee1f146f66ba2553637"); define("AAACP","f57292224bc1db484a36fc6e47f3f71b2"); define("AAACM","We're unable to generate response at this time. Please try again."); define("AAACJ","Please enter a valid api key in configuration file."); define("AAACH","invalid_api_key"); define("AAACE","suggest_questions:"); define("AAACC","get_insight output:"); define("AAACA","get_insight:"); define("AAABZ","```"); define("AAABX","```json"); define("AAABV","Error: No valid JSON found"); define("AAABT","fdb38ad8c760ac1619bf9ef5917bc0ebe:"); define("AAABR","str_getcsv"); define("AAABQ","make_json_readable output:"); define("AAABP","make_json_readable:"); define("AAABN","empty json input"); define("AAABL","message"); define("AAABK","choices"); define("AAABI","ff890b9052a455c13fdfabdb87ce1e0ae reponse:"); define("AAABF","Content-Type: application/json"); define("AAABC","json_object"); define("AAABA","type"); define("AAAAX","response_format"); define("AAAAW","json"); define("AAAAV","stop"); define("AAAAU","top_p"); define("AAAAT","max_completion_tokens"); define("AAAAS","temperature"); define("AAAAQ","content"); define("AAAAO","user"); define("AAAAL","role"); define("AAAAK","messages"); define("AAAAJ","meta-llama/llama-4-scout-17b-16e-instruct"); define("AAAAG","model"); define("AAAAE","https://api.groq.com/openai/v1/chat/completions"); define("AAAAD",""); define("AAAAC","EN"); define("ZZZZ","AI_LANG");  ?><?php

if (!defined(ZZZZ))
define(ZZZZ,AAAAC); class ai_grid
...
}"; ai_grid::$v15d61712450a686a7f365adf4fef581f = AAAAW; error_log(AAABP.$v4ae35dbb42614d2429b7d6d181a950bb); $vb4a88417b3d0170d754c647c30b7216a = ai_grid::f5ed33f7008771c9d49e3716aeaeca581($v4ae35dbb42614d2429b7d6d181a950bb); error_log(AAABQ.($vb4a88417b3d0170d754c647c30b7216a)); $vb4a88417b3d0170d754c647c30b7216a = json_decode($vb4a88417b3d0170d754c647c30b7216a); if ($vb4a88417b3d0170d754c647c30b7216a->error) 
...
error_log(AAABT.$vd1fc8eaf36937be0c3ba8cfe0a2c1bfe); preg_match('~\{(?:[^{}]|(?R))*\}~', $vd1fc8eaf36937be0c3ba8cfe0a2c1bfe, $v9c28d32df234037773be184dbdafc274); return !empty($v9c28d32df234037773be184dbdafc274[0]) ? $v9c28d32df234037773be184dbdafc274[0] : AAABV; }
...
"; $vb4a88417b3d0170d754c647c30b7216a = ai_grid::f5ed33f7008771c9d49e3716aeaeca581($v4ae35dbb42614d2429b7d6d181a950bb); $vb4a88417b3d0170d754c647c30b7216a = str_replace(AAABX,AAAAD,$vb4a88417b3d0170d754c647c30b7216a); $vb4a88417b3d0170d754c647c30b7216a = str_replace(AAABZ,AAAAD,$vb4a88417b3d0170d754c647c30b7216a); return $vb4a88417b3d0170d754c647c30b7216a; }
...
"; error_log(AAACA.$v4ae35dbb42614d2429b7d6d181a950bb); ai_grid::$v15d61712450a686a7f365adf4fef581f = AAAAW; $vb4a88417b3d0170d754c647c30b7216a = ai_grid::f5ed33f7008771c9d49e3716aeaeca581($v4ae35dbb42614d2429b7d6d181a950bb); error_log(AAACC.$vb4a88417b3d0170d754c647c30b7216a); $vb4a88417b3d0170d754c647c30b7216a = json_decode($vb4a88417b3d0170d754c647c30b7216a); if ($vb4a88417b3d0170d754c647c30b7216a->error) 
ai_grid::f5c1479a0fb821237d662b94a18ba3233($vb4a88417b3d0170d754c647c30b7216a); return $vb4a88417b3d0170d754c647c30b7216a; }
...
{ if ($vd1fc8eaf36937be0c3ba8cfe0a2c1bfe->error->code == AAACH)
$vd1fc8eaf36937be0c3ba8cfe0a2c1bfe->error = AAACJ; else
$vd1fc8eaf36937be0c3ba8cfe0a2c1bfe->error = AAACM; }
}
}

if (!defined(AAACP) && !defined(AAACR))
{ 
function ffe97cb337457fee1f146f66ba2553637($vf1f713c9e000f5d3f280adbd124df4f5, $v03fdad155b7548884584c7c39b0c5cd2 = 2, $vead60a4fe9e35d6e4f9f3e8ebdf32d02 = 0, $v4e5868d676cb634aa75b125a0f741abf = 0) { $v6eedc03a68a69933c763e674f2d7c42f = AAACT; $v851f5ac9941d720844d143ed9cfcf60a = str_repeat(AAACW, $vead60a4fe9e35d6e4f9f3e8ebdf32d02); foreach ($vf1f713c9e000f5d3f280adbd124df4f5 as $key => $v2063c1608d6e0baf80249c42e2be5804) { $v867fd4c34db986c640ac965d6b58310c = is_int($key); if (is_array($v2063c1608d6e0baf80249c42e2be5804) && !empty($v2063c1608d6e0baf80249c42e2be5804)) { $v468ba46bbdda22d8ea7081d8068ed7df = array_keys($v2063c1608d6e0baf80249c42e2be5804) === range(0, count($v2063c1608d6e0baf80249c42e2be5804) - 1); if ($v867fd4c34db986c640ac965d6b58310c) { if ($v468ba46bbdda22d8ea7081d8068ed7df) { foreach ($v2063c1608d6e0baf80249c42e2be5804 as $v447b7147e84be512208dcc0995d67ebc) { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . AAACX; if (is_array($v447b7147e84be512208dcc0995d67ebc)) { $v8b04d5e3775d298e78455efc5ca404d5 = true; foreach ($v447b7147e84be512208dcc0995d67ebc as $v518d8dec3947df909fe6e4c9940f98a6 => $v99ec682294cfb0f1c96b29ac20433cf6) { if ($v8b04d5e3775d298e78455efc5ca404d5) { $v6eedc03a68a69933c763e674f2d7c42f .= AAACW . $v518d8dec3947df909fe6e4c9940f98a6 . AAACY; $v8b04d5e3775d298e78455efc5ca404d5 = false; } else { $v6eedc03a68a69933c763e674f2d7c42f .= "\n" . $v851f5ac9941d720844d143ed9cfcf60a . AAACZ . $v518d8dec3947df909fe6e4c9940f98a6 . AAACY; }
...
} else { $v6eedc03a68a69933c763e674f2d7c42f .= AAACW . f8e5b15c74a3fe89571128eb66f54897d($v99ec682294cfb0f1c96b29ac20433cf6) . "\n"; }
}
} else { $v6eedc03a68a69933c763e674f2d7c42f .= AAACW . f8e5b15c74a3fe89571128eb66f54897d($v447b7147e84be512208dcc0995d67ebc) . "\n"; }
}
} else { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . AAACX; $v8b04d5e3775d298e78455efc5ca404d5 = true; foreach ($v2063c1608d6e0baf80249c42e2be5804 as $v518d8dec3947df909fe6e4c9940f98a6 => $v99ec682294cfb0f1c96b29ac20433cf6) { if ($v8b04d5e3775d298e78455efc5ca404d5) { $v6eedc03a68a69933c763e674f2d7c42f .= AAACW . $v518d8dec3947df909fe6e4c9940f98a6 . AAACY; $v8b04d5e3775d298e78455efc5ca404d5 = false; } else { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . AAACZ . $v518d8dec3947df909fe6e4c9940f98a6 . AAACY; }
...
} else { if ($v867fd4c34db986c640ac965d6b58310c) { if (is_string($v2063c1608d6e0baf80249c42e2be5804) && strpos($v2063c1608d6e0baf80249c42e2be5804, "\n") !== false) { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . '- |\n'; $v980da98409d058c365664ff7ea33dd6b = explode("\n", $v2063c1608d6e0baf80249c42e2be5804); foreach ($v980da98409d058c365664ff7ea33dd6b as $v6438c669e0d0de98e6929c2cc0fac474) { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . AAACZ . $v6438c669e0d0de98e6929c2cc0fac474 . "\n"; }
} else { $v6eedc03a68a69933c763e674f2d7c42f .= $v851f5ac9941d720844d143ed9cfcf60a . AAADC . f8e5b15c74a3fe89571128eb66f54897d($v2063c1608d6e0baf80249c42e2be5804) . "\n"; }
...
if (is_bool($v2063c1608d6e0baf80249c42e2be5804)) { return $v2063c1608d6e0baf80249c42e2be5804 ? AAADK : AAADL; }
...
continue; } else { $v43b5c9175984c071f30b873fdce0a000 = &$vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAADX]; if (isset($vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAAEG])) { $v43b5c9175984c071f30b873fdce0a000 = &$vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAAEG]; }

if ($vab0e549d2a8443cc837f6184800edbd4 === AAAEC) { $v43b5c9175984c071f30b873fdce0a000[$vec0650218823d76a3a7b1e31fee1893c] = implode("\n", $v1ef0fe4040450a5ce2ffc5521d618374); } else { $v43b5c9175984c071f30b873fdce0a000[$vec0650218823d76a3a7b1e31fee1893c] = implode(AAAEI, $v1ef0fe4040450a5ce2ffc5521d618374); }
...
while (count($vfac2a47adace059aff113283a03f6760) > 1 && $vead60a4fe9e35d6e4f9f3e8ebdf32d02 <= $vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAAEA]) { array_pop($vfac2a47adace059aff113283a03f6760); }
...
$vfac2a47adace059aff113283a03f6760[] = [AAADX => &$v43b5c9175984c071f30b873fdce0a000[$key], AAAEA => $vead60a4fe9e35d6e4f9f3e8ebdf32d02]; }

$veac22b102a30112d6e74c8dc6af0b915 = $vead60a4fe9e35d6e4f9f3e8ebdf32d02; }
}

if ($vab0e549d2a8443cc837f6184800edbd4 !== null) { $v43b5c9175984c071f30b873fdce0a000 = &$vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAADX]; if (isset($vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAAEG])) { $v43b5c9175984c071f30b873fdce0a000 = &$vfac2a47adace059aff113283a03f6760[count($vfac2a47adace059aff113283a03f6760) - 1][AAAEG]; }
...
function unf8e5b15c74a3fe89571128eb66f54897d($v2063c1608d6e0baf80249c42e2be5804) { $v2063c1608d6e0baf80249c42e2be5804 = trim($v2063c1608d6e0baf80249c42e2be5804); if ($v2063c1608d6e0baf80249c42e2be5804 === AAADI || $v2063c1608d6e0baf80249c42e2be5804 === AAAEO || $v2063c1608d6e0baf80249c42e2be5804 === AAACT) { return null; }

if (in_array(strtolower($v2063c1608d6e0baf80249c42e2be5804), [AAADK, AAADN, AAADR])) { return true; }
if (in_array(strtolower($v2063c1608d6e0baf80249c42e2be5804), [AAADL, AAADO, AAADS])) { return false; }

if ((substr($v2063c1608d6e0baf80249c42e2be5804, 0, 1) === AAAEQ && substr($v2063c1608d6e0baf80249c42e2be5804, -1) === AAAEQ) ||
